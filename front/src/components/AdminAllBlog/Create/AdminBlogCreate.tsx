...
import useAdminBlogCreate from 'components/AdminAllBlog/Create/hooks/useAdminBlogCreate';

const { TextArea } = Input;

interface IMyBlogCreate {
	hideModal: () => void;
}

const AdminBlogCreate: FC<IMyBlogCreate> = ({ hideModal }) => {
	const { form, onFinishHandler, isLoading, imageSelected, setImageSelected } = useAdminBlogCreate(hideModal);
