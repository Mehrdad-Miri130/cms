...
import useMyBlogCreate from 'components/MyBlog/Create/hooks/useMyBlogCreate';
...
const MyBlogCreate: FC<IMyBlogCreate> = ({ hideModal }) => {
	const { form, onFinishHandler, isLoading, imageSelected, setImageSelected } = useMyBlogCreate(hideModal);
